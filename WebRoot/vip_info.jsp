	...
	<div id="main">
		...
		<div id="right">
			<table>
				...
				<s:iterator value="#request.consumes" var="cons">
					<tr>
						<td><s:property value="#cons.vip.vipid" /></td>
						<td><s:property value="#cons.vip.name" /></td>
						<td><s:date name="#cons.vip.joinTime" format="yyyy-MM-dd"/></td>
						<td><s:property value="#cons.vip.age" /></td>
						<td><s:property value="#cons.consumeId" /></td>
						<td><s:property value="#cons.commodityName" /></td>
						<td><s:property value="#cons.price" /></td>
						<td><s:property value="#cons.practicePrice" /></td>
					</tr>
				</s:iterator>
			</table>
